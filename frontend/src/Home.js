    ...
    <div>
        ...
        <div className="container py-5">
          ...
          <div className="row justify-content-center">
            <div className="col-md-6">
              <input
                type="text"className="form-control form-control-lg shadow-sm rounded-pill"
              ...
              <div className="card product-card border-0 shadow-sm w-100 rounded-4">
                ...
                <div className="card-body d-flex flex-column">
                  ...
                  <div className="mt-auto">
                    ...
                    <Link to={`/product/${p.id}`} className="btn btn-outline-primary btn-sm w-100 py-2 fw-bold">
                      View Details
                    </Link>
                  </div>
                </div>
      ...
      <div className="container mt-5 py-5 border-top border-bottom bg-light rounded-5">
        <div className="d-flex justify-content-between align-items-center mb-4 px-2">
          ...
          <Link to="/shop" className="btn btn-sm btn-primary px-3 rounded-pill">
            View All Shop →
          </Link>
        </div>
        <div className="row">
